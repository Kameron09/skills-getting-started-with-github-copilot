...
activities = {
    ...
    "Soccer Team": {
        "description": "Competitive soccer team practicing skills, fitness, and teamwork",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM; games on Saturdays",
        "max_participants": 22,
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and put on performances each term",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM; performances monthly",
        "max_participants": 25,
